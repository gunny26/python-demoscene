...
class TestVector(unittest.TestCase):
    ...
    def test_dot(self):
        obj = Vector(1, 2, 3, 1)
        self.assertEqual(obj.dot(Vector(1, 2, 3, 1)), 14)

    def test_cross(self):
        obj = Vector(1, 0, 0, 1)
        result = obj.cross(Vector(1, 0, 0, 1))
        self.assertEqual(result, Vector(0.000000, 0.000000, 0.000000, 1.000000))
        obj = Vector(1, 0, 0, 1)
        result = obj.cross(Vector(0, 1, 0, 1))
        self.assertEqual(result, Vector(0.000000, 0.000000, 1.000000, 1.000000))
        obj1 = Vector(-1, 1, 0, 1).unit()
        self.assertTrue( 1.0 - 1e-10 < obj1.length() < 1.0 + 1e-10)
        obj2 = Vector(1, 1, 0, 1).unit()
        self.assertTrue( 1.0 - 1e-10 < obj1.length() < 1.0 + 1e-10)
    ...
    def test_add(self):
        result = Vector(1, 2, 3, 1) + Vector(1, 2, 3, 1)
        self.assertEqual(result, Vector(2.000000, 4.000000, 6.000000, 1.000000))
    ...
    def test_div(self):
        result = Vector(2, 4, 6, 1) / 2
        self.assertEqual(result, Vector(1.000000, 2.000000, 3.000000, 1.000000))

    def test_idiv(self):
        result = Vector(2, 4, 6, 1) 
        result /= 2
        self.assertEqual(result, Vector(1.000000, 2.000000, 3.000000, 1.000000))
